...
class UserAddress(models.Model):
    user = models.ForeignKey("Users", on_delete=models.SET_NULL, null=True, help_text="用户")
...
class OrderGoods(models.Model):
    ...
    original_price = models.FloatField(help_text="原价")
...
class Merchants(models.Model):
    ...
    level = models.ForeignKey("Levels", on_delete=models.SET_DEFAULT, default=1)
    createtime = models.CharField(max_length=255, help_text="创建时间")
